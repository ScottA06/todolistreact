...
var ToDoList = function (_React$Component) {
    ...
    _createClass(ToDoList, [{
        ...
        value: function deleteTask(id) {
            ...
            fetch('https://fewd-todolist-api.onrender.com/tasks/' + id + '?api_key=66', {
                method: "DELETE",
                mode: "cors"
            }).then(checkStatus).then(json).then(function (data) {
                _this2.fetchTasks(); // fetch tasks after delete
        ...
        value: function toggleComplete(id, completed) {
            ...
            fetch('https://fewd-todolist-api.onrender.com/tasks/' + id + '/mark_' + newState + '?api_key=66', {
                method: "PUT",
                mode: "cors"
            }).then(checkStatus).then(json).then(function (data) {
                _this3.fetchTasks();
        ...
        value: function fetchTasks() {
            ...
            fetch('https://fewd-todolist-api.onrender.com/tasks?api_key=66').then(checkStatus).then(json).then(function (response) {
        ...
        value: function handleSubmit(event) {
            ...
            fetch('https://fewd-todolist-api.onrender.com/tasks?api_key=66', {
                method: "POST",
                mode: "cors",
